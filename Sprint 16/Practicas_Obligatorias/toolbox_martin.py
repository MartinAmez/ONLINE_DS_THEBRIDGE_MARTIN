...
def plot_variable_distribution(dataframe, variable):
    """
    Visualiza la distribución de una variable en un DataFrame.

    Parameters:
    - dataframe (pd.DataFrame): El DataFrame que contiene los datos.
    - variable (str): El nombre de la variable cuya distribución se desea visualizar.

    Returns:
    None
    """
    plt.figure(figsize=(8, 6))
    sns.histplot(dataframe[variable], kde=True, color='blue', bins=40)
